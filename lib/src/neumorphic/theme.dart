...
class NeuTheme extends StatelessWidget {
  ...
  ///
  /// Defaults to [NeuThemeData.fallback] if there is no [NeuTheme] in the given
  /// build context.
  ///
...
class AnimatedNeuTheme extends ImplicitlyAnimatedWidget {
  ...
  @override
  AnimatedWidgetBaseState createState() => _AnimatedThemeState();
}
...
class _AnimatedThemeState extends AnimatedWidgetBaseState<AnimatedNeuTheme> {
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    ...
    _data = visitor(_data, widget.data,
            (value) => NeumorphicThemeDataTween(begin: value))
